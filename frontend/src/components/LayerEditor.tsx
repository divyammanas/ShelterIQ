    ...
    >
      ...
      <div className="flex-1 min-w-[120px]">
        <select
          ...
          className="w-full bg-white dark:bg-[#121622] border border-slate-200 dark:border-[#1e2638] rounded-lg px-2.5 py-1.5 text-xs outline-none focus:ring-1 focus:ring-blue-500 text-slate-900 dark:text-slate-100"
        >
      ...
      <div className="flex items-center gap-1.5 shrink-0 w-24">
        <input
          ...
          className="w-full text-right bg-white dark:bg-[#121622] border border-slate-200 dark:border-[#1e2638] rounded-lg px-2.5 py-1.5 text-xs outline-none focus:ring-1 focus:ring-blue-500 text-slate-900 dark:text-slate-100 font-mono"
        />
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <button 
        ...
        className="flex items-center gap-2 border border-slate-200 dark:border-[#1e2638] bg-white dark:bg-[#121622] hover:bg-slate-50 dark:hover:bg-[#182030] text-slate-700 dark:text-slate-300 text-xs font-medium px-3.5 py-2 rounded-lg transition-all w-fit shadow-2xs"
      >
