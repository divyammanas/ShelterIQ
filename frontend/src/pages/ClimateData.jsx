...
export const ClimateData = () => {
    const { climateParams, updateClimateParams, importClimateCSV, runActiveSimulation } = useApp();
    ...
    return (<div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
      ...
      <div className="lg:col-span-4 bg-white dark:bg-[#0c0c0f] border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 shadow-sm flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div onClick={() => fileInputRef.current?.click()} className="flex flex-col items-center justify-center border-2 border-dashed border-zinc-200 dark:border-zinc-800 hover:border-blue-500 dark:hover:border-blue-500 rounded-xl p-6 cursor-pointer bg-zinc-50/50 dark:bg-zinc-900/20 hover:bg-zinc-50 dark:hover:bg-zinc-900/40 transition-all text-center group">
