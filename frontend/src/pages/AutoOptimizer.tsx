...
import { Play, Import, ListCollapse, Award, Loader2, Check, Sliders } from 'lucide-react';
...
export const AutoOptimizer: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
      ...
      <div className="lg:col-span-5 bg-white dark:bg-[#121622] border border-slate-200 dark:border-[#1e2638] rounded-xl p-5 shadow-xs flex flex-col gap-6">
        <h3 className="text-xs font-mono font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400 flex items-center gap-2 border-b border-slate-200 dark:border-[#1e2638] pb-3 shrink-0">
          <ListCollapse size={15} className="text-blue-500" /> Search Combinatorics
        </h3>
      ...
      <div className="lg:col-span-7 bg-white dark:bg-[#121622] border border-slate-200 dark:border-[#1e2638] rounded-xl p-5 shadow-xs flex flex-col gap-6">
        <h3 className="text-xs font-mono font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400 flex items-center gap-2 border-b border-slate-200 dark:border-[#1e2638] pb-3 shrink-0">
          <Award size={15} className="text-blue-500" /> Optimal Evaluated Envelope Assemblies
        </h3>
        ...
        <div className="space-y-4 max-h-[500px] overflow-y-auto pr-1">
          ...
          {optResults.length === 0 && (
            <div className="flex flex-col items-center justify-center text-center text-zinc-400 py-16 gap-3">
              <Sliders size={36} className="text-zinc-200 dark:text-zinc-800" />
