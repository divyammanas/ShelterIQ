  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
      ...
      <form 
        ...
        className="lg:col-span-4 bg-white dark:bg-[#121622] border border-slate-200 dark:border-[#1e2638] rounded-xl p-5 shadow-xs flex flex-col gap-4"
      >
        <h3 className="text-xs font-mono font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400 flex items-center gap-2 border-b border-slate-200 dark:border-[#1e2638] pb-3 shrink-0">
          <Plus size={15} className="text-blue-500" /> Register Custom Material
        </h3>
      ...
      <div className="lg:col-span-8 bg-white dark:bg-[#121622] border border-slate-200 dark:border-[#1e2638] rounded-xl p-5 shadow-xs flex flex-col gap-4">
        <h3 className="text-xs font-mono font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400 flex items-center gap-2 border-b border-slate-200 dark:border-[#1e2638] pb-3 shrink-0">
          <Database size={15} className="text-blue-500" /> Standard Materials Library
        </h3>
